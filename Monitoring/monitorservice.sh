...
/usr/local/bin/curl -H "Content-Type: application/json" -X POST --data @$MONITORING_FILE --url http://10.10.10.10/MaviUcakFirewallService/MaviUcakFirewallService.svc/json/MonitoringPackageUpload
